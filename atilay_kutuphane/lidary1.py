...
y1 = serial.Serial("/dev/ttyAMA"+str(2), 115200)
...
def read_data_y1():
    ...
    while True:
        time.sleep(0.08)
        counter = y1.in_waiting # count the number of bytes of the serial po>
        if counter > 8:
            bytes_serial = y1.read(9)
            y1.reset_input_buffer()
            ...
            if bytes_serial[0] == 0x59 and bytes_serial[1] == 0x59: # this >
                ...
                print(distance)
                dosya=open("/home/rasp/atilay/lidy1","w")
